...
## _あなたは高い技術力を持ったテックリードです。<br>AI Agentを使いこなして高い生産性と品質を<br>両立させて下さい。_
...
- 僕なりにもう一段分解してみる
  - <span class="font-bold" v-mark="{ type: 'underline', color: 'red' }">テスト観点の「保証」</span>: 問題がないことをテストすること
  - <span class="font-bold" v-mark="{ type: 'underline', color: 'red' }">予防観点での「保証」</span>: 問題発生の予防に務めること
  - <span class="font-bold" v-mark="{ type: 'underline', color: 'red' }">サポート観点での「保証」</span>: 問題が起きた時に対処すること
...
- **テスト観点の「保証」**: 外部品質を満たしているか
- **予防観点での「保証」**: 内部品質を満たしているか
- **サポート観点での「保証」**: 問題発生時に対処できるか
...
現時点では、これらは人間にしかない「能力」

---
layout: fact
---

## 品質保証はエンジニアが担う<br>一部労力をAIが担う
...
- AIに求めるべきは、品質保証の「能力」ではなく「労力」
- 「丁寧な指示」と「AIに委託する労力 >>> 指示労力」を意識することが重要
...
_あなたは高い技術力を持ったテックリードです。<br>AI Agentを使いこなして高い生産性と品質をを両立させて下さい。_
