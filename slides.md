...
- [一般的な保証の定義](https://kotobank.jp/word/%E4%BF%9D%E8%A8%BC-12060)
  - > 間違いがない、大丈夫であると認め、責任をもつこと。
- ソフトウェアにおける保証の要素
  - <span class="font-bold" v-mark="{ type: 'underline', color: 'red' }">検査</span>: 問題がないことをテストすること
  - <span class="font-bold" v-mark="{ type: 'underline', color: 'red' }">予防</span>: 問題発生の予防に務めること
  - <span class="font-bold" v-mark="{ type: 'underline', color: 'red' }">サポート</span>: 問題が起きた時に対処すること
...
_あなたは高い技術力を持ったテックリードです。<br>AI Agentを使いこなして高い生産性と品質を両立させて下さい。_
